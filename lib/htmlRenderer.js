...
const close_and_open_div_row_and_deck = () => {
  let template = `</div> </div> <div class="row justify-content-center"> <div class="card-deck mx-2 mb-2">`;
  return template;
};
const renderManager = (manager) => {
  ...
  if (noOfRenderedEmployees % 3 === 0) {
    template += close_and_open_div_row_and_deck();
  }
  return template;
};
